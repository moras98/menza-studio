    ...
    return(
        <>
            ...
            <Section backgroundColor={'white'}>
                <SectionContent>
                    <div id="servicio-1" className="about-information">
                        <div className="left">
                            <UnderlinedTitle>
                                <h3>SERVICIO 1</h3>
                            </UnderlinedTitle>
                    ...
                    <div id="servicio-2" className="about-information">
                        <div className="left">
                            <UnderlinedTitle>
                                <h3>SERVICIO 2</h3>
                            </UnderlinedTitle>
                    ...
                    <div id="servicio-3" className="about-information">
                        <div className="left">
                            <UnderlinedTitle>
                                <h3>SERVICIO 3</h3>
                            </UnderlinedTitle>
                    ...
                    <div id="servicio-4" className="about-information">
                        <div className="left">
                            <UnderlinedTitle>
                                <h3>SERVICIO 4</h3>
                            </UnderlinedTitle>
                    ...
                    <div id="servicio-5" className="about-information">
                        <div className="left">
                            <UnderlinedTitle>
                                <h3>SERVICIO 5</h3>
                            </UnderlinedTitle>
                    ...
                    <div id="servicio-6" className="about-information">
                        <div className="left">
                            <UnderlinedTitle>
                                <h3>SERVICIO 6</h3>
                            </UnderlinedTitle>
